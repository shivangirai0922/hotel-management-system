...
<?php
    ...
    $bookings=Array();
    $con=connectDb();
    $query="SELECT bookings.*, users.email as bookeiEmail, users.name as bookeiName FROM `bookings` JOIN `users` ON bookings.userId=users.email ORDER BY bookings.id DESC";
...
<html lang="en">
    <head>
        ...
        <title>Bookings - Rai's Hotel</title>
    ...
    <body class="bg-light">
                    ...
                    <table class="table table-bordered table-striped border-dark">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="custom-select booking-status-update" id="<?= $booking['id'] ?>">
                            ...
                            <tr>
                                <td colspan="12">No <?= $page ?> in the record</td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
        ...
        <script type="text/javascript" src="./assets/js/bookings.js"></script>
    </body>
</html>
